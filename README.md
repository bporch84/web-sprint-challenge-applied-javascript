...
1. What is the DOM?
The document object model is a represention of the page that was can manipulate.
2. What is an event?
Events are actions that happen on the page.
3. What is an event listener?
An event listener checks for specific actions and can be used to make something happen when those events take place.
4. Why would we convert a NodeList into an Array?
Is we need to use an advanced array methd on it that we can't use with a NodeList.
5. What is a component?
A component is a function that takes up a part of the webpage. It's a smaller part of the whole page that we can handle separately.
